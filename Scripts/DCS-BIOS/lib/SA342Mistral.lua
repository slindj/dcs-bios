...
defineIndicatorLight("FD_LAMP_LEU", 227, "Indicator Lights", "FD Lamp LEU")
defineIndicatorLight("FD_LAMP_G_VIDE1", 223, "Indicator Lights", "FD Lamp G Vide1")
defineIndicatorLight("FD_LAMP_G_VIDE2", 224, "Indicator Lights", "FD Lamp G Vide2")
defineIndicatorLight("FD_LAMP_D_VIDE1", 225, "Indicator Lights", "FD Lamp D Vide1")
defineIndicatorLight("FD_LAMP_D_VIDE2", 226, "Indicator Lights", "FD Lamp D Vide2")
defineIndicatorLight("RADAR_ALT_ALARM_LAMP", 97, "Indicator Lights", "Radar Altimeter Alarm Lamp")
defineIndicatorLight("AM_RADIO_LAMP", 141, "Indicator Lights", "AM Radio Lamp")
defineIndicatorLight("RWR_LIGHT", 196, "Indicator Lights", "RWR Light")
defineIndicatorLight("GYRO_TEST_LAMP", 201, "Indicator Lights", "Gyro Test Lamp")
defineIndicatorLight("GYRO_TRIM_WARNING_LAMP", 202, "Indicator Lights", "Gyro Trim Warning Lamp")
...
defineIndicatorLight("LOW_TURBINE_RPM", 4, "Warning Panel", "Low Turbine RPM Warning")
defineIndicatorLight("GENERATOR_WARNING", 5, "Warning Panel", "Generator Warning")
defineIndicatorLight("ALTERNATOR_WARNING", 6, "Warning Panel", "Alternator Warning")
defineIndicatorLight("BATTERY_WARNING", 7, "Warning Panel", "Battery Warning")
defineIndicatorLight("AUTOPILOT", 8, "Warning Panel", "Autopilot Warning")
defineIndicatorLight("AC_115V_BUS_NAV", 9, "Warning Panel", "AC 115 V Bus/NAV Warning")
defineIndicatorLight("LOW_FUEL", 10, "Warning Panel", "Low Fuel Warning")
defineIndicatorLight("LOW_ROTOR_RPM", 11, "Warning Panel", "Low Rotor RPM Warning")
